...
| P1     | Analytics 结果语义与展示一致性    | 已完成（第一阶段） | 让预测、风险和质量结果可解释、可比较、可操作           | 第二批   |
...
- 将当前展示适配器继续拆分为正式 i18n 资源，覆盖完整的中英文文案和日期/数字 locale。
- 补充 Analytics 页面组件级断言、移动端视觉回归和低风险高关注项的端到端展示验证。
